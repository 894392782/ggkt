    ...
    public String upload(MultipartFile file) {
        ...
        try{
            ...
            PutObjectRequest putObjectRequest =
                    new PutObjectRequest(ConstantPropertiesUtil.BUCKET_NAME,
                            key,
                            inputStream,
                            objectMetadata);
            ...
            String url = "https://"+ConstantPropertiesUtil.BUCKET_NAME+"."+"cos"+"."+ConstantPropertiesUtil.END_POINT+".myqcloud.com"+"/"+key;
            return url;
